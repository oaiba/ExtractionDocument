...
> **Cross-References:** [Core Gameplay Loop](CoreLoop.md) (Information Gathering, infiltration phase), [Hero Abilities](Hero_Abilities.md) (drone, overlay, smoke), [Extraction Mechanics](Extraction_Mechanics.md) (extraction notifications), [Design Pillars](../../ProjectScope/design-pillars-enhanced.md) (enemy visibility must be fair).
...
- [Design Pillars](../../ProjectScope/design-pillars-enhanced.md) — Fair visibility, no unclear threats.
