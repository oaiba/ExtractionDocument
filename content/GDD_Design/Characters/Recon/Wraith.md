...
| Firing Reveals | Muzzle flash briefly visible        | 1 second           |

#### Tactical Uses

| Use Case       | Strategy                 |
| :------------- | :----------------------- |
| **Escape**     | Cover retreat            |
| **Entry**      | Confuse enemy positions  |
| **Revive**     | Block enemy sightlines   |
| **Extraction** | Cover helicopter arrival |
...
| **Disorienting**  | Enemies exiting smoke are briefly confused |
...
| **Tactical**  | Smoke Grenades ×2 | Additional smoke |
...
| Trigger            | Line                                                    |
| :----------------- | :------------------------------------------------------ |
| Ability Activation | "視界を奪う。" (Shikai wo ubau - Stealing their vision) |
...
| :---------- | :----------------------------------------- |
| **PHANTOM** | Respects her intel, dislikes being tracked |
