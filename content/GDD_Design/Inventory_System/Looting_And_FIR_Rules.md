...
2. **Searching:** A progress bar appears.
   * _Perception Skill:_ Reduces search time.
...
* **Loss of Status:** If a player brings an item _into_ a raid, or dies with it in their Secure Container (depending on server settings), it loses FIR status.
...
* **Dogtag:** A specialized 1-slot item on the body.
  * _Contains:_ Level, Killer Name, Weapon Used, Distance.
  * _Value:_ Higher Level = Higher Sell Price. Can be bartered for end-game gear.
* **Weight Management:** You cannot carry everything. Choosing to take a dead enemy's heavy Class 6 Armor means dropping your own or moving at snail's pace. For container types, rig/backpack capacities, and secure container rules, see [Gears — Storage Gear](https://github.com/oaiba/ExtractionDocument/blob/main/content/GDD_Design/Gears/StorageGear/README.md) and [Containers](https://github.com/oaiba/ExtractionDocument/blob/main/content/GDD_Design/Inventory_System/Containers.md).
