...
This document defines **flat storage** (no bag-in-bag), **backpack collapse** when empty, and how weapons with attachments are stored. For item list see [Storage Master Database](Storage_Master_Database.md).
