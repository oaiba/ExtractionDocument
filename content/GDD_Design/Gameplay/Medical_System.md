...
The medical system prioritizes realistic injury management over arcade-style HP regeneration. Players must diagnose the specific type of injury and apply the correct treatment. This creates a secondary layer of tactical decision-making: *you are never truly safe until you are healed.*
...
<!-- REF_IMAGE: Body hitzone diagram — front and back silhouette showing each body region with its HP value (Head: 35, Thorax: 85, Stomach: 70, Arms: 60 each, Legs: 65 each) -->
...
<!-- REF_IMAGE: Medical items tier list — visual grid showing all items organized by category with rarity color coding and inventory slot sizes -->
...
> See [Combat, Weapons & Gear](../../Combat/) for how armor durability and penetration interact with the body part damage system.
