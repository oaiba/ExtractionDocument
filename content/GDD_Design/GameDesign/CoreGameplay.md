...
**UI Elements:**
- **Risk Indicator** - Shows total loadout value
- **Insurance Option** - Future feature for partial recovery
- **Recommended Loadouts** - Based on quest/skill
- **Quick Loadout Slots** - Save favorite builds (5 slots)
