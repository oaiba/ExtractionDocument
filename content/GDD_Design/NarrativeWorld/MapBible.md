...
> **Cross-References:** [MapLayouts](MapLayouts.md) — choke points, extraction points, POI combat data; [LootDistribution](LootDistribution.md) — heatmaps and container tables; Per-map lore in [MapLore_Industrial](MapLore_Industrial.md) and [MapLore_Urban](MapLore_Urban.md).
...
> These principles govern how **level art direction and prop placement** deliver narrative. For full per-map implementations, see [MapLore_Industrial](MapLore_Industrial.md) and [MapLore_Urban](MapLore_Urban.md). For lore delivery channels (audio logs, codex, etc.), see [Lore Delivery Systems](Lore_Delivery.md).
...
**The Last Stand:**
Bathroom stall, subway station. Skeleton + revolver + one spent casing + door barricaded from inside.
*Story: A survivor heard the threats coming, realized escape was impossible, and made a final choice. No log needed.*

**The Deal Gone Wrong:**
Alleyway behind a pharmacy. Two skeletons facing each other. Duffel bag of meds between them. Both have knives in their chests.
*Story: A trade turned violent. The loot — the meds — is still there for the player who finds this.*

**The Hopeless Signal:**
Rooftop generator + radio tower + "SOS" painted in white. Generator out of fuel. Skeleton sits by the radio, headphones on.
