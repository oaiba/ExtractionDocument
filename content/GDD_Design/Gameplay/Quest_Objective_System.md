...
> **Loyalty Level unlocks:** Each level unlocks better item availability and pricing. See [GameDesign/Progression](https://github.com/oaiba/ExtractionDocument/blob/main/content/GameDesign/Progression.md) for full Loyalty Level requirements.
...
Some quests require completion of a chain from _another_ trader first — creating natural decision points:
