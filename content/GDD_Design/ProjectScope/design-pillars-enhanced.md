...
* **Example**: _"Extract with 5 Medkits"_, _"Kill 3 enemies with headshots"_
...
* **Example**: _"Mark 3 enemy supply drops for airstrike"_
...
* Tension says: _Healing must create vulnerability (risk)_
...
* Agency says: _Players need clear objectives (accessibility)_
...
* Fluidity says: _Instant weapon swap (responsive)_
* Narrative says: _Realistic swap speed (heavy weapons slow)_
