...
**Characteristics:**
- Stylized nhân vật proportions với realistic PBR materials và lighting
- Post-collapse industrial decay layered với cyberpunk technology remnants
...
| nhân vật | Authentic gear silhouettes, real proportions as base | 1:6.5 head ratio, 10-15% exaggerated gear |
...
**Concept:** A collapsing world where advanced technology persists in fragments. The contrast between ruin và tech is the game's visual signature.

**Past vs. Present:**

| trước Collapse | sau Collapse |
| :-------------- | :------------- |
...
**Visual Rule:** Every exterior scene requires at least **one warm neon source** (orange/amber) và **one cool neon source** (cyan/teal) to maintain cyberpunk identity.

<!-- REF_IMAGE: Neon Decay trước-và-sau comparison — showing a corporate district in its prime vs. post-collapse với overgrown tech và flickering neon -->

### Pillar 2: Tactical Clarity

**Concept:** Gameplay readability is non-negotiable. From the top-down camera, every element phải được instantly identifiable.
...
| Distance | chi tiết Level | Effect |
| :------- | :----------- | :----- |
| 0-50 units | Full chi tiết, all effects, max particles | người chơi immediate area |
| 50-100 units | High chi tiết, reduced particles | Engagement range |
| 100-200 units | Medium chi tiết, billboard vegetation | Awareness range |
| 200+ units | Low chi tiết, fog, simplified shapes | Atmospheric backdrop |

### Pillar 3: Stylized Grit

**Concept:** Everything looks functional và worn, nhưng với stylized proportions that make designs memorable và iconic. No fantasy magic — all technology, all grounded.

**Not This:** Fantasy giáp, magical runes, anime proportions  
**nhưng This:** Tactical gear với personality, cybernetic enhancements, custom modifications

**Material Focus:**
- Kevlar, ballistic nylon, carbon fiber composites
- Weathered metal với cyberpunk LED accents
- Medical-grade fabrics với holographic diagnostic patches
- Industrial rubber, tool leather, polymer plates
- Tech surfaces: matte black với orange/cyan indicator lights

---

## Master Color Palette

### Brand cốt lõi (4 Colors)

These four colors define the game's entire visual identity. All other colors derive from hoặc complement this foundation.
...
<!-- REF_IMAGE: Brand palette reference card — showing all 4 colors as large swatches với full hex values, RGB, và HSL breakdowns -->
...
| Faction | primary | secondary | Neon Accent | cách dùng |
| :------ | :------ | :-------- | :---------- | :-- |
...
2. tạo atmosphere thông qua neon-lit decay
3. Guide người chơi attention với motivated light sources
4. Differentiate zones thông qua color temperature và neon density
...
- Outdoor areas cách dùng **neon signage** và **flickering holographic billboards** as accent lights
- Shadows are deep và sharp — the contrast between lit và unlit areas is dramatic
- Rim lighting on nhân vật is **always active** for gameplay readability
...
<!-- REF_IMAGE: Lighting preset comparison — showing the same environment under Overcast Day, Neon Night, và Golden Hour conditions -->
...
| Zone | Color Temp | chính Light | Neon Density | Mood |
| :--- | :--------- | :-------- | :----------- | :--- |
| Edge / Forest | 5500K | Overcast daylight | Sparse (abandoned tech) | Natural, cautious |
| Mid / Urban | 4500K | Mixed natural + neon | Medium (signs, màn hình) | Transitional tension |
| Hot / Industrial | 4000K | Harsh spots + neon | High (LED strips, cảnh báo) | Industrial danger |
| cốt lõi / Labs | 6500K+ | Colored emergency | Maximum (full cyberpunk) | Extreme danger |
...
**chính Visual Elements:**
- Massive smokestacks (landmark silhouettes)
- Rusted catwalks và gantry networks
- Conveyor hệ thống (non-functional, some jammed mid-cycle)
- Chemical storage tanks với faded cảnh báo labels
- Graffiti — survivor messages và faction territory tags
- Nature reclaiming: vines thông qua grating, moss on pipes

**Cyberpunk Layer:**
- Malfunctioning LED strip lights along rooflines
- Holographic "DANGER" và "NEXUS CORP" signs still projecting
- Automated hệ thống running empty cycles (robotic arms, conveyors)
- Data cables bundled và hanging from overhead structures
...
<!-- REF_IMAGE: Industrial zone concept art — showing rusted infrastructure với orange neon cảnh báo signs và cyan data cable bundles -->

### Urban Zone

**chính Visual Elements:**
- High-rise buildings in varied damage trạng thái (intact to collapsed)
- Street-level storefronts (shattered glass, looted interiors)
- Abandoned vehicles (some với operational hazard lights)
- Billboard frames — many still displaying glitched holographic ads
- Public art installations (damaged, repurposed as cover)
- Makeshift barricades from debris và furniture

**Cyberpunk Layer:**
- Neon signs at storefronts (some lit, most flickering hoặc broken)
- Vending machines với glowing màn hình (functional — sell consumables)
...
- Vehicle wrecks (APCs, trucks) in varied destruction trạng thái
- Camouflage netting stretched over chính positions

**Cyberpunk Layer:**
- Automated turret emplacements (some still active)
- Holographic perimeter cảnh báo projections
- EMP shielding panels on chính structures
...
- Faded road signs với QR codes và digital displays (dark)
...
<!-- REF_IMAGE: Zone comparison grid — showing Industrial, Urban, Military, và Nature zones side-by-side at the same thời gian of day -->

---

## nhân vật Style Guide
...
| Class | Build | chính Visual | Cyberpunk Element | Color Accent |
| :---- | :---- | :--------- | :---------------- | :----------- |
| Assault | Athletic | Cross-chest đạn belt, medium helmet | Wrist đạn counter | Orange #F97316 |
...
| Tank | Heavy | Shield plates, riot visor, thick giáp | Power-assist frame glow | Red #DC2626 |
| Specialist | Medium | Tool belt, utility pouches, asymmetric | Wrist hacking device | Amber #F59E0B |

**Skin Tone và Diversity:**
- Operators represent diverse ethnicities và body types
- Base nhân vật models support 5+ skin tone maps
- cosmetic customization includes face paint, tattoos, scars
- All cosmetics are non-gameplay-affecting

<!-- REF_IMAGE: nhân vật class lineup — showing all 5 operator classes in front view và top-down view với cyberpunk chi tiết highlighted -->

---

## vũ khí Style Guide

### vũ khí Visual Philosophy
...
3. hiển thị rõ wear that tells a story (scratches, tape repairs, custom engravings)
4. Attachment modularity clearly hiển thị rõ (rails, mounting points)
...
| Attachment | Mounting Point | Silhouette Change | Cyberpunk chi tiết |
| :--------- | :------------- | :---------------- | :--------------- |
| Optic / Scope | Top rail | Profile height increase | Holographic reticle hiển thị rõ |
...
| Magazine | Body fixed position | Size varies với capacity | Digital round counter on extended mags |
| Laser | Side rail | Minimal | hiển thị rõ beam (red/green/IR toggle) |
...
- **Center:** người chơi — highest contrast, sharpest rim light
- **Near field (50 units):** Immediate threats và loot — high contrast, effects active
- **Mid field (100 units):** Environment chi tiết — medium contrast, reduced particles
- **Far field (200+ units):** Atmospheric backdrop — low contrast, fog, simplified geometry

### Color Temperature Gradient

From người chơi outward, the image should transition:
```
Warm (player area, neon orange)  →  Neutral (mid-range)  →  Cool (distance, blue-gray fog)
```

This tạo natural depth và focuses attention on the gameplay center.
...
| Overwatch 2 | Stylized proportions, clean readability, nhân vật identity |
| The Division 2 | Urban ruins, tactical gear authenticity, cover objects |
| Apex Legends | Bold nhân vật design, vibrant color coding |
| Gears Tactics | Top-down combat clarity, environmental chi tiết |
...
<!-- REF_IMAGE: Final mood board collage — combining industrial photography, neon cityscapes, tactical gear, và concept art references in the orange-white-black-cyan palette -->
