...
**Owner:** Lead Designer. **Review cadence:** Monthly (see [Scope Review & Planning](https://github.com/oaiba/ExtractionDocument/blob/main/content/GDD_Design/ProjectScope/project-scope-review-and-planning.html) §5.3).
...
**Owner:** Economy Lead / Live Ops. **Review cadence:** Monthly (see [Scope Review & Planning](https://github.com/oaiba/ExtractionDocument/blob/main/content/GDD_Design/ProjectScope/project-scope-review-and-planning.html) §5.3).
...
| Monthly   | Full risk matrix review with leadership; **D4 (Cross-Platform)** and **B3 (Economy inflation)** owners report (see [Scope Review & Planning](https://github.com/oaiba/ExtractionDocument/blob/main/content/GDD_Design/ProjectScope/project-scope-review-and-planning.html) §5.3). |
