---
title: "vũ khí Arsenal & Combat hệ thống"
type: docs
weight: 25
---
...
1. **Tactical Over Twitch** — Positioning và quyết định-making matter more than raw reflexes. The top-down camera amplifies this by giving người chơi full spatial awareness.
2. **vũ khí Identity** — Every vũ khí category has a distinct role. No single "best gun for all situations" exists.
3. **Risk vs. Reward** — Better vũ khí extract more giá trị from a raid nhưng carry a heavier loss penalty nếu you die.
...
**Tactical ghi chú:** Strong opening vũ khí. Good for holding angles. Versatile in most combat scenarios. Magazine management is critical in sustained fights.

#### AR Full Reference

| Code Name | Display Name | Caliber | Rarity | Damage | RPM | Mag | Range (m) | Recoil | Penetration | giá trị ($) | ghi chú |
| :-------- | :----------- | :------ | :----- | :----: | :-: | :-: | :-------: | :----- | :---------- | --------: | :---- |
...
| Recoil | High nhưng manageable |

**Tactical ghi chú:** Excellent for building clearing. Grants high movement speed. Weak at range. High đạn consumption — carry extras.

#### SMG Full Reference

| Code Name | Display Name | Caliber | Rarity | Damage | RPM | Mag | Range (m) | Recoil | Mobility | giá trị ($) | ghi chú |
| :-------- | :----------- | :------ | :----- | :----: | :-: | :-: | :-------: | :----- | :------- | --------: | :---- |
...
**Tactical ghi chú:** Devastating in confined spaces — useless at range. High risk/high reward. Limited đạn capacity demands careful counting.

#### Shotgun Full Reference

| Code Name | Display Name | Caliber | Rarity | Dmg/Pellet | Pellets | RPM | Capacity | Range (m) | giá trị ($) | ghi chú |
| :-------- | :----------- | :------ | :----- | :--------: | :-----: | :-: | :------: | :-------: | --------: | :---- |
...
**Role:** Semi-auto precision at medium-long range; bridge between AR và Sniper. Faster follow-up than bolt-action; lower per-shot damage than sniper.
...
**Tactical ghi chú:** 2–3 shot kills at optimal range. Reposition between shots; cách dùng cover for reload. Best used from positions between AR và Sniper engagement ranges. Xem [vũ khí Categories Deep Dive](../vũ khí/Weapon_Categories_Deep_Dive.md) for DMR doctrine và matchups.

#### DMR Full Reference

| Code Name | Display Name | Caliber | Rarity | Damage | RPM | Mag | Range (m) | giá trị ($) | ghi chú |
| :-------- | :----------- | :------ | :----- | :----: | :-: | :-: | :-------: | --------: | :---- |
...
**Tactical ghi chú:** Requires positioning và patience. Top-down perspective makes sniping unique — best used from elevated positions hoặc long corridors. Vulnerable nếu rushed.

#### Sniper Rifle Full Reference

| Code Name | Display Name | Caliber | Rarity | Damage | RPM | Mag | Range (m) | Bullet Vel. | giá trị ($) | ghi chú |
| :-------- | :----------- | :------ | :----- | :----: | :-: | :-: | :-------: | :---------- | --------: | :---- |
...
**Tactical ghi chú:** Heavy vũ khí — reduces movement speed. Excellent for holding choke points. Long reload tạo a vulnerability window. Bipod reduces recoil khi prone/crouched.

#### LMG Full Reference

| Code Name | Display Name | Caliber | Rarity | Damage | RPM | Mag | Range (m) | Bipod | Mobility | giá trị ($) | ghi chú |
| :-------- | :----------- | :------ | :----- | :----: | :-: | :-: | :-------: | :---: | :------- | --------: | :---- |
...
**Role:** Backup vũ khí, last resort, silent option.
...
| Code Name | Display Name | Rarity | Slash Dmg | Backstab Dmg | Range (m) | Speed | giá trị ($) | ghi chú |
| :-------- | :----------- | :----- | :-------: | :----------: | :-------: | :---- | --------: | :---- |
...
| WPN_MELEE_BATON | Stun Baton | Rare | 40 | 80 | 2.0 | Very Fast | 1,200 | Stuns địch 2 sec |
...
Ammunition is the bridge between vũ khí và target. While the gun dictates handling, the **đạn Type** dictates the impact kết quả. Our caliber hệ thống tạo shared đạn pools across vũ khí categories — a strategic inventory choice.

### đạn Variants (Per Caliber)

| Variant | Role | Penetration | Flesh Damage | chi phí |
| :------ | :--- | :---------- | :----------- | :--- |
| **Standard (FMJ/Ball)** | Balanced | Medium | Medium | Cheap |
| **giáp Piercing (AP)** | giáp Destroyer | High → Extreme | Reduced (over-pen) | Expensive, rare |
| **Hollow Point (HP)** | Flesh Tearer | None → Low | Very High, causes bleeding | Moderate |
| **Tracer** | Visual Feedback | Mixed | Mixed | Standard |

**AP cách dùng Case:** Late-game PvP, boss hunting.
**HP cách dùng Case:** "Leg meta" (unarmored limbs), AI scavs.
**Tracer Trade-off:** hiển thị rõ flight path giúp aiming — nhưng reveals your position to địch.

### Full Caliber Reference bảng
...
| Code Name | Display Name | Rarity | Magnification | Effect | Drawback | giá trị ($) | Compatible |
| :-------- | :----------- | :----- | :-----------: | :----- | :------- | --------: | :--------- |
...
| ATT_OPTIC_THERMAL | Thermal Scope | Epic | 2.5× | See thông qua smoke/fog | −20% ADS, battery | 5,000 | AR, Sniper, LMG |
| ATT_OPTIC_SNIPER | 8× Sniper Scope | Rare | 8.0× | +50m range, precision | −30% ADS speed | 2,000 | Sniper only |
| ATT_OPTIC_REFLEX | Reflex Sight | Common | 1.0× | +8% accuracy, fast ADS | None | 150 | All vũ khí |

### Barrels

| Code Name | Display Name | Rarity | Effect | Drawback | giá trị ($) | Compatible |
| :-------- | :----------- | :----- | :----- | :------- | --------: | :--------- |
...
| ATT_UNDER_LASER | Laser Sight | Common | +25% hip-fire accuracy | hiển thị rõ to địch | 200 | All |
| ATT_UNDER_LIGHT | Tactical Light | Common | +Visibility in dark (+30m) | hiển thị rõ to địch | 150 | All |
| ATT_UNDER_BIPOD | Bipod | Rare | −40% recoil khi prone/crouched | +1s setup thời gian | 800 | LMG, Sniper |
...
- Depletes với each hit — does not regenerate trong khi raid
- phải được replaced hoặc repaired (Safe House repair bench)
- giáp class determines which đạn types can penetrate — see caliber bảng above
...
**Recoil Patterns:**
- Each vũ khí has a unique 2D recoil pattern (vertical pull + horizontal drift)
...
| Range | hệ thống |
| :---- | :----- |
| < 20m | Hitscan — instant kết quả |
| > 20m | Projectile — travel thời gian applies |
...
| Concrete | None | — |
| người chơi | Over-penetration possible | Minimal (hits target behind) |
...
- Blind fire option — fires mà không exposing nhân vật body (reduced accuracy)
...
## thời gian to Kill (TTK)

**Target:** 100 HP, 50 giáp

| vũ khí Type | TTK (Optimal) | Shots to Kill |
| :---------- | :-----------: | :-----------: |
...
**Design mục tiêu:** TTK fast enough to reward skill execution; slow enough for counterplay và disengagement windows.

---

## vũ khí Rarity, giá trị & Acquisition

### Rarity bảng

| Rarity | Color | Spawn Rate | Average giá trị | Attachment Slots |
| :----- | :---- | :--------: | :-----------: | :--------------: |
...
**Legendary Bonuses:** Unique skin, +5% damage stat, special tracer colors, và prestige auction-house floor giá trị.
...
| **Tracer Rounds** | Every 5th round — aiming feedback mà không full reveal |

### Audio Design

| Sound | Design mục đích |
| :---- | :------------- |
| **Gunshot volume** | Indicates distance of threat to all nearby người chơi |
| **Directional audio** | Stereo panning reveals địch bearing |
...
## vũ khí Balance Principles

1. **Availability ≠ Power** — Common vũ khí are easier to obtain; Legendary vũ khí are not always best for every situation.
2. **Risk premium** — Expensive loadouts carry heavier loss. người chơi must consciously decide khi to risk high-tier gear.
3. **Skill floor** — Sniper rifles và LMGs require positioning knowledge. SMGs allow aggressive play at lower skill investment.
4. **Meta prevention** — Regular balance patches, vũ khí rotation in seasonal loot pools, community feedback integration.
5. **No dominant option** — Every vũ khí category has a role where it outperforms others. No vũ khí nên được universally "the best pick."
