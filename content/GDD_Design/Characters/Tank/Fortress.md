...
| Effect            | Value               | Notes             |
| :---------------- | :------------------ | :---------------- |
| Self Armor Boost  | +50 temporary armor | On top of current |
| Ally Armor Boost  | +25 temporary armor | All in range      |
| Damage Resistance | +15% (self)         | During ability    |
| Slow Immunity     | Yes                 | Cannot be slowed  |
...
| Option                | Effect                              |
| :-------------------- | :---------------------------------- |
| **Shared Resistance** | Allies also get +10% damage resist  |
| **Armor Regen**       | Allies regenerate 5 armor/sec       |
| **Fortified**         | Duration extends 2 seconds per kill |

**Slot 3 (Level 35):**
| Option             | Effect                                     |
| :----------------- | :----------------------------------------- |
| **Last Stand**     | If downed during ability, allies keep buff |
| **Iron Curtain**   | Allies take 30% less headshot damage       |
...
| Slot          | Item            | Notes            |
| :------------ | :-------------- | :--------------- |
| **Primary**   | PKM LMG         | Suppressive fire |
| **Secondary** | Makarov Pistol  | Russian standard |
| **Tactical**  | Armor Plates ×2 | Team durability  |
...
| :---------- | :----------------------------------------- |
| **HAVOC**   | Fellow Russian, respects but worries about |
