...
> **Cross-References:** [Medical System](medical_system/index.html) — interactions between food/water items and toxicity; [Core Gameplay Loop](coreloop/index.html) — Phase 5 Recovery; [Looting & Inventory](looting_interactions/index.html) — food/water as barter category; [Environmental Hazards](environmental_hazards/index.html) — environment effects on depletion rate.
...
| :-------- | :-------------- | :----------- | :----- |
| **Stomach blacked** | ×8 drain (4/min) | ×4 drain (4/min) | Limb damage per [Medical System](medical_system/index.html) |
...
| **Stimulant injectors (active)** | −15 per injection (immediate) | No effect | Toxicity trade-off per [Medical System](medical_system/index.html) |
...
| Golden Star Balm (crossover) | +15 Energy | 0 | 2.0 s | 1×1 | Pain remover + Energy; per [Medical System](medical_system/index.html) |
...
- Food/water items have **no weight penalty** (they are 0.1–0.3 kg per item; accounted for in standard weight tables in [Gear Mechanics](gear_mechanics/index.html)).
...
Toxicity accumulation from stimulant injectors (per [Medical System](medical_system/index.html)) is a separate bar. However, stimulant items DO drain Hydration as a side effect (see accelerated drain table above).
...
Between raids, players restore Energy and Hydration in the [Safe House](../gamedesign/safe_house_design/index.html):
...
- [Medical System](medical_system/index.html) — Body part HP (Stomach = depletion multiplier); toxicity system; stimulant item effects.
- [Looting & Inventory](looting_interactions/index.html) — Food/water as Provisions barter category.
- [Gear Mechanics](gear_mechanics/index.html) — Food/water item weight in loadout budget.
- [Core Gameplay Loop](coreloop/index.html) — Phase 1 preparation; loadout packing decisions.
