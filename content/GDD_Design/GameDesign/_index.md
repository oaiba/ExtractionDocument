...
{{< cards cols="3" >}}
  ...
  {{< card link="tutorialraid.html" title="Onboarding" icon="academic-cap" subtitle="First-time user experience (FTUE)." >}}
  {{< card link="usersettings.html" title="Settings Menu" icon="cog" subtitle="Graphics, audio, and gameplay configuration." >}}
  {{< card link="navigationandmap.html" title="Map & UI" icon="map" subtitle="In-game map, compass, and ping system." >}}
{{< /cards >}}
