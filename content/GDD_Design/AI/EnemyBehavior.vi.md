---
title: "AI & địch Behavior Design"
type: docs
---

## AI Design Philosophy

**cốt lõi Principle:** AI should enhance the extraction trải nghiệm, not replace PvP

AI địch serve as:
- **Loot guardians** - Protect valuable areas
- **Tension creators** - Keep người chơi on edge even mà không PvP contact
- **Skill tests** - Predictable patterns that reward mastery
- **Sound traps** - Engaging AI tạo noise, attracting người chơi

**NOT:**
- Main adversaries (PvP is the cốt lõi tension)
- Unfair hoặc unpredictable
- Bullet sponges
- Trivially easy
...
**mục đích:** Easy to kill, noise makers, loot pinatas
...
**Loot Drop:** Common items, đạn, medical supplies
**Threat Level:** 

**Behavior chi tiết:**
- Patrols in small area (10m radius)
- Alerts nearby scavengers khi engaged
- Flees at 20% HP
...
- Uses cover trong khi combat
- Calls for backup nếu possible
...
**mục đích:** Actual threats, require tactical approach
...
**Loot Drop:** Rare vũ khí, optics
**Threat Level:** 

**Behavior chi tiết:**
- Does NOT patrol (stationary overwatch)
- Laser sight warns người chơi (1.5s trước shot)
- Repositions sau 3 shots
- Vulnerable trong khi repositioning
- Audio cue: Loud shot echo (alerts other người chơi)

---

### Tier 3: Elites (Rare)

**mục đích:** Mini-bosses, guard high-giá trị loot
...
**Loot Drop:** Epic items, LMG, heavy giáp
**Threat Level:** 

**Behavior chi tiết:**
- Announced by heavy footsteps (audio cảnh báo)
...
- Uses flashbangs trước engaging
- Retreats với smoke grenades khi damaged
- Most intelligent AI type
- Coordinates với other Operatives

---

### Tier 4: Bosses (Legendary)

**mục đích:** High-risk, high-reward encounters
...
**Loot Drop:** Legendary vũ khí/giáp guaranteed, rare crafting materials
**Threat Level:** 

**Design ghi chú:**
- Announced 30 seconds trước appearing (alarm sounds)
- tạo massive noise (attracts người chơi)
...
- Drones phải được destroyed first (80 HP each)
- Shields regenerate nếu drones are alive
- Blinks away khi attacked directly
...
## AI Behavior hệ thống

### Detection hệ thống

**Three Detection trạng thái:**
...
| Alert   | Engaged | người chơi spotted trong khi search      |
...
- Investigate sounds trong khi patrol
- Return to patrol sau alert timeout
...
| Looter    | Moderate, cách dùng cover    | 15% HP          |
| Guard     | Aggressive, no retreat | Never           |
| Sniper    | Evasive, reposition    | khi flanked    |
...
**Cover Behavior:**
- Peek và shoot (2-3 shots)
- Reload behind cover
- Switch cover nếu flanked
- Grenade flush nếu người chơi camps

### Suppression

**khi AI Uses Suppression:**
- người chơi behind cover for 5+ seconds
- Multiple AI present
- Heavy/Guard types

**Suppression Effect on người chơi:**
- Camera shake (light)
- Reduced accuracy nếu standing
- Audio feedback (bullets snapping)

### Flanking

**Flank Trigger:**
- người chơi stationary in cover for 10+ seconds
- 2+ AI present
- One AI suppresses, one moves

**Flank Path:**
- Attempt wide angle (90°+)
- cách dùng cover trong khi movement
- Coordinate timing với suppressor
...
**NOT used** - We want nhất quán, learnable AI
...
| Cautious   | Heavy cover cách dùng, slow advance |
| Normal     | Balanced                      |
...
| Alert → Engaged | "There! địch!" callout |
...
### Kill thời gian (TTK) Targets

| AI Type   | người chơi TTK (target) | AI TTK (người chơi target) |
| :-------- | :------------------ | :--------------------- |
...
**AI nên được:**
- Soloable với skill và caution
- Faster/easier với squad coordination
- Never trivial regardless of squad size

**Scaling (OPTIONAL for hot zones):**
| người chơi in Area | AI Damage | AI máu |
| :-------------- | :-------- | :-------- |
| 1               | 100%      | 100%      |
| 2               | 110%      | 110%      |
| 3+              | 120%      | 125%      |
