...
3. **Atmospheric Immersion**: tạo distinctive atmosphere for each zone
...
**Mood Keywords:** Oppressive, cơ chế, Echoing, Abandoned
...
| Wind thông qua Holes | Whistling | -26dB | Yes |
...
|:------|:------------|:-------|:----------|
| Wind thông qua Trees | Constant rustle | -18dB | Always |
...
| Leaves Underfoot | người chơi-caused | -16dB | Movement |
