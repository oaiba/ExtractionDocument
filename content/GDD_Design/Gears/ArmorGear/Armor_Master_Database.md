...
| Code       | Display Name    | Tier | Class | Zones | Material | Weight (kg) | Durability | Grid | Move % | Ergo | Repair Loss | Value ($) | Trader | Rarity |
| ---------- | --------------- | :--: | ----- | ----- | -------- | ----------- | ---------- | ---- | ------ | ---- | ----------- | --------- | ------ | ------ |
| VEST_PACA  | PACA Soft Armor | 1    | 2     | T     | Aramid   | 1.9         | 50         | 2×3  | −2     | −3   | 2%          | 1,000     | 1      | Common |
...
| VEST_KILLA | Killa Armor  | 4    | 5     | T, S, A    | UHMWPE   | 9.2         | 80         | 3×3  | −11    | −16  | 4%          | 95,000    | 4      | Epic   |
