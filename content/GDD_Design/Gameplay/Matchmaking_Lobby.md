...
> **Cross-References:** [Core Gameplay Loop](CoreLoop.md) — Phase 1 Preparation; [Extraction Mechanics](Extraction_Mechanics.md) — disconnection timeout rule; [Controls](../../GameDesign/Controls.md) — platform-specific lobby UI input; [Hero Abilities](Hero_Abilities.md) — operator selection before deploy.
...
| **Ranked** | Rated matchmaking pool (separate from casual). See [RankedMode](../../GameDesign/RankedMode.md). | Separate pool |
...
| Tutorial Raid | AI-only server. No other players. See [TutorialRaid](../../GameDesign/TutorialRaid.md). |
...
- [Controls](../../GameDesign/Controls.md) — Platform-specific lobby input.
- [GameDesign/RankedMode](../../GameDesign/RankedMode.md) — Ranked queue pool and requirements.
- [GameDesign/TutorialRaid](../../GameDesign/TutorialRaid.md) — First-time player routing.
