...
{{< callout type="info" >}}
**Core Tenet:** Every social interaction should have friction. Trust is earned through actions, not given by a UI element. The Karma system ensures that every handshake — and every betrayal — has consequences.
{{< /callout >}}
...
- **Revive System:** High-risk, high-reward. Requires vulnerability and trust.
