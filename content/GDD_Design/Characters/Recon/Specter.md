...
| Sensor HP       | 20                        | Destroyable                   |
| Alert Type      | Audio + Visual ping       | Directional                   |
...
| **Wide Angle**    | Detection range +3 meters |

**Slot 2 (Level 20):**
| Option           | Effect                                    |
| :--------------- | :---------------------------------------- |
| **Slow Field**   | Detected enemies slowed 15% for 2 seconds |
| **Silent Alarm** | Enemies don't know they triggered sensor  |
...
| **Tactical**  | Motion Sensors ×3, Claymore ×1 | Layered traps       |
...
| Kill (Trap Assist) | "Caught in my web."                 |
...
| :----------- | :------------------------------------- |
| **PHANTOM**  | Former adversaries, now uneasy respect |
